...
begin
  MVC := TMVCEngine.Create(self,
    ...
    begin
      Config[TMVCConfigKey.ViewPath] := ExtractFilePath(GetModuleName(HInstance)) + '..\..\templates';
  ...
  MVC.AddMiddleware(TMVCStaticFilesMiddleware.Create('/static', { StaticFilesPath }
