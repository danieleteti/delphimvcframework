...
begin
  FMVC := TMVCEngine.Create(Self,
    ...
    begin
      ...
      // Is the server mapped under a specific path? (eg. HTTP.sys specific path?)
      // With HTTP.sys this settings allows more servers to listen on the same port.
  ...
  // To enable output compression add this middleware as the last one (Only for INDY based web servers)
  // NOTE: HTTP.sys web servers use internal engine for compression
