program renders_spring4d_collections;
...
uses
  ...
  UMVCWebModule in 'UMVCWebModule.pas' {MyWebModule: TWebModule},
  Entities in 'Entities.pas',
  Spring4DCollectionsSerializer in 'Spring4DCollectionsSerializer.pas';
