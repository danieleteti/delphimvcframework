program repository_showcase;

uses
  Vcl.Forms,
  MainFormU in 'MainFormU.pas' {MainForm},
  RepositoriesU in 'RepositoriesU.pas',
  ...
  EngineChoiceFormU in '..\activerecord_showcase\EngineChoiceFormU.pas',
  EntitiesU in '..\activerecord_showcase\EntitiesU.pas';
