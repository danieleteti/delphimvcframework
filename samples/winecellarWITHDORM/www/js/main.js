...
function addWine() {
	...
	$.ajax({
		...
		error: function(jqXHR, textStatus, errorThrown){
			...
			alert('addWine error: ' + JSON.parse(jqXHR.responseText).message);
		}
	});
}
...
function updateWine() {
    ...
    processData: false,
		...
		error: function(jqXHR, textStatus, errorThrown){
			alert('updateWine error: ' + JSON.parse(jqXHR.responseText).message);
		}
	});
}
...
function deleteWine() {
	...
	$.ajax({
		...
		error: function(jqXHR, textStatus, errorThrown){
			alert('deleteWine error: ' + JSON.parse(jqXHR.responseText).message);
		}
	});
}
