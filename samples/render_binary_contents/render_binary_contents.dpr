...
begin
  ...
  try
    ...
    ShellExecute(0, 'open', PChar('http://localhost:' + inttostr(APort) + '/api/files/Image00001.jpg'), nil, nil, SW_SHOWMAXIMIZED);
    ShellExecute(0, 'open', PChar('http://localhost:' + inttostr(APort) + '/api/streams/Image00002.jpg'), nil, nil, SW_SHOWMAXIMIZED);
