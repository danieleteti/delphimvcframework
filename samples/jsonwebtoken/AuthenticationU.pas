...
uses System.SysUtils, MVCFramework.Commons, System.Generics.Collections, MVCFramework;
...
begin
  ...
  begin
    ...
    if UserName = 'user1' then
      ...
      UserRoles.Add('role2')
    else if UserName = 'user3' then // all the roles
    begin
      UserRoles.Add('role1');
      UserRoles.Add('role2');
    end;
...
procedure TAuthenticationSample.OnAuthorization(const AContext: TWebContext; UserRoles: TList<System.string>;
  const ControllerQualifiedClassName: string; const ActionName: string; var IsAuthorized: Boolean);
begin
  IsAuthorized := False;
