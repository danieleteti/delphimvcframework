...
var
  ...
  CurrPage: Integer;
begin
  Filters := Context.Request.BodyAsJSONObject;
  ...
  Render<TPerson>(PeopleModule.FindPeople(SearchText, CurrPage), True,
  ...
  MergePaginationMetainfos('/people/searches?page=%d',
    Context.Response.CustomHeaders, CurrPage);
