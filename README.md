...
**Table of Contents**
  ...
  - [DelphiMVCFramework 3.2.1-carbon is here 📥 !](#delphimvcframework-321-carbon-is-here--)
  - [DelphiMVCFramework - the official guide](#delphimvcframework---the-official-guide)
    - [Translations](#translations)
  - [How to install DMVCFramework](#how-to-install-dmvcframework)
    - [Do you want to partecipate to DMVCFramework development or tests?](#do-you-want-to-partecipate-to-dmvcframework-development-or-tests)
  - [What users say about DMVCFramework](#what-users-say-about-dmvcframework)
  - [DMVCFramework Main Features](#dmvcframework-main-features)
  - [Overview of DelphiMVCFramework 3.2.1-carbon](#overview-of-delphimvcframework-321-carbon)
    - [Improvements](#improvements)
    - [Bug Fixes](#bug-fixes)
  - [Older Releases](#older-releases)
    - [Overview of DelphiMVCFramework 3.2.0-boron](#overview-of-delphimvcframework-320-boron)
      - [Breaking Changes in 3.2.0-boron](#breaking-changes-in-320-boron)
      - [Bug Fixes in 3.2.0-boron](#bug-fixes-in-320-boron)
  - [3.2.2-nitrogen ("repo" version)](#322-nitrogen-repo-version)
  - [Roadmap](#roadmap)
  - [Trainings, consultancy or custom development service](#trainings-consultancy-or-custom-development-service)
  - [Release Notes](#release-notes)
    - [3.2.0 (boron)](#320-boron)
      - [Breaking Changes in 3.2.0-boron](#breaking-changes-in-320-boron-1)
      - [Bug Fixes in 3.2.0-boron](#bug-fixes-in-320-boron-1)
    - [3.1.0 (lithium)](#310-lithium)
    - [3.0.0 (hydrogen)](#300-hydrogen)
    - [2.1.3 (lithium)](#213-lithium)
    - [2.1.2 (helium)](#212-helium)
    - [2.1.1 (hydrogen)](#211-hydrogen)
  - [Samples and documentation](#samples-and-documentation)
- [Getting Started: 5 minutes guide](#getting-started-5-minutes-guide)
  - [DelphiMVCFramework 3.2.0-boron Installation](#delphimvcframework-320-boron-installation)
  - [Sample Controller](#sample-controller)
  - [How to pack more than one DMVCFramework listener in the same executable](#how-to-pack-more-than-one-dmvcframework-listener-in-the-same-executable)
  - [RQL](#rql)
    - [RQL as Implemented by DMVCFramework](#rql-as-implemented-by-dmvcframework)
        - [Not Yet Availables](#not-yet-availables)
  - [Links](#links)
