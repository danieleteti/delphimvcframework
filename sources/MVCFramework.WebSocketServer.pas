...
constructor TWebSocketServer.Create(const AWSPort: Word);
begin
...
procedure TWebSocketServer.Connect(AContext: TIdContext);
begin
...
procedure TWebSocketServer.Disconnect(AContext: TIdContext);
begin
...
procedure TWebSocketServer.Execute(AContext: TIdContext);
begin
