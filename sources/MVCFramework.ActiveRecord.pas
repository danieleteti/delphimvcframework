...
begin
  ...
  begin
    ...
    lIsPK := lField = ATableMap.fPrimaryKey;
    if lIsPK then
      lFieldOptions := ATableMap.fPrimaryKeyOptions
    else if ATableMap.fMap.TryGetValue(lField, lFieldInfo) then
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              if not lPrimaryFieldTypeAsStr.IsEmpty then
              begin
                raise EMVCActiveRecord.Create('Only one PK field is allowed but entity [' + ClassName + '] has more than 1 PK');
              end;
...
begin
  ...
  begin
    Result := GetFieldNameForSQL(TableMap.fPrimaryKeyFieldName);
    lFirst := False;
  end;
