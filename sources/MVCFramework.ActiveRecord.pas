...
{$ENDIF}
  ...
  TMVCUnitOfWork<T: TMVCActiveRecordFireDAC> = class(TInterfacedObject, IMVCUnitOfWork<T>, IMVCMultiExecutor<T>)
  private
...
procedure TMVCUnitOfWork<T>.DoItemApplyAction(const Obj: TMVCActiveRecordFireDAC; const EntityAction: TMVCEntityAction;
  const ItemApplyAction: TMVCItemApplyAction<T>; var Handled: Boolean);
begin
