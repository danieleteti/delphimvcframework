...
class function TMVCActiveRecordFireDAC.SelectDataSet(const SQL: string; const Params: array of Variant;
...
{$ENDIF}
  ...
  TMVCActiveRecordList = class(TObjectList<TMVCActiveRecordBase>)
  public
  ...
  public
    ...
    class function SelectDataSet(const SQL: string; const Params: array of Variant;
      ...
      const DirectExecute: Boolean = False): TDataSet; virtual; abstract;
  end;

  IMVCUnitOfWork<T: TMVCActiveRecordBase> = interface
  ...
  TMVCItemApplyAction<T: TMVCActiveRecordBase> = reference to procedure(const Obj: T;
  ...
  IMVCMultiExecutor<T: TMVCActiveRecordBase> = interface
  ...
  TMVCActiveRecordHelper = class helper for TMVCActiveRecordBase
    ...
    class function GetByPK(const aClass: TMVCActiveRecordBaseClass; const aValue: TGuid;
      const RaiseExceptionIfNotFound: Boolean = True): TMVCActiveRecordBase; overload;
    class function GetByPK<T: TMVCActiveRecordBase, constructor>(const aValue: string; const aFieldType: TFieldType;
      const RaiseExceptionIfNotFound: Boolean): T; overload;
    class function GetByPK<T: TMVCActiveRecordBase, constructor>(const aValue: Int64;
      const RaiseExceptionIfNotFound: Boolean = True): T; overload;
    class function GetByPK<T: TMVCActiveRecordBase, constructor>(const aValue: string;
      const RaiseExceptionIfNotFound: Boolean = True): T; overload;
    class function GetByPK<T: TMVCActiveRecordBase, constructor>(const aValue: TGuid;
      const RaiseExceptionIfNotFound: Boolean = True): T; overload;

    { Select }
    class function Select<T: TMVCActiveRecordBase, constructor>(const SQL: string;
      const Params: array of Variant;
      const Options: TMVCActiveRecordLoadOptions = []): TObjectList<T>; overload;
    class function Select<T: TMVCActiveRecordBase, constructor>(
      const SQL: string;
      const Params: array of Variant;
      const ParamTypes: array of TFieldType;
    ...
    class function Select(
      const MVCActiveRecordClass: TMVCActiveRecordBaseClass;
      const SQL: string;
      const Params: array of Variant;
      const ParamTypes: array of TFieldType;
      const Options: TMVCActiveRecordLoadOptions = [])
    ...
    class function LoadFromDataSet<T: TMVCActiveRecordBase, constructor>(
    ...
    class function Select(const aClass: TMVCActiveRecordBaseClass; const SQL: string;
      const Params: array of Variant)
      : TMVCActiveRecordList; overload;
...
{$ENDIF}
    { SelectOne }
    class function SelectOne<T: TMVCActiveRecordBase, constructor>(const SQL: string;
      const Params: array of Variant;
    ...
    function SelectRQL(const RQL: string; const MaxRecordCount: Integer)
      : TMVCActiveRecordList; overload;
    class function SelectRQL<T: constructor, TMVCActiveRecordBase>(const RQL: string;
      const MaxRecordCount: Integer)
      : TObjectList<T>; overload;
    class function SelectRQL<T: constructor, TMVCActiveRecordBase>(const RQL: string;
      const MaxRecordCount: Integer; const OutList: TObjectList<T>): UInt32; overload;
    class function SelectOneByRQL<T: constructor, TMVCActiveRecordBase>(const RQL: string;
      const RaiseExceptionIfNotFound: Boolean = True): T; overload;
    class function SelectRQL(const aClass: TMVCActiveRecordBaseClass; const RQL: string;
      const MaxRecordCount: Integer)
      : TMVCActiveRecordList; overload;
    class function SelectRQL(const aClass: TMVCActiveRecordBaseClass; const RQL: string;
    ...
    { Misc }
    class function All<T: TMVCActiveRecordBase, constructor>: TObjectList<T>; overload;
    class function DeleteRQL<T: TMVCActiveRecordBase>(const RQL: string = ''): Int64; overload;
    class function Count<T: TMVCActiveRecordBase>(const RQL: string = ''): Int64; overload;
{$IF Defined(CUSTOM_MANAGED_RECORDS)}
    class function UseTransactionContext: TMVCTransactionContext;
{$ENDIF}

    { Where }
    class function Where<T: TMVCActiveRecordBase, constructor>(const SQLWhere: string;
      const Params: array of Variant)
      : TObjectList<T>; overload;
    class function Where<T: TMVCActiveRecordBase, constructor>(const SQLWhere: string;
      const Params: array of Variant;
...
{$ENDIF}
    { GetXXXByWhere }
    class function GetOneByWhere<T: TMVCActiveRecordBase, constructor>(const SQLWhere: string;
    ...
    class function GetOneByWhere<T: TMVCActiveRecordBase, constructor>(const SQLWhere: string;
      ...
      const RaiseExceptionIfNotFound: Boolean = True): T; overload;
    class function GetFirstByWhere<T: TMVCActiveRecordBase, constructor>(const SQLWhere: string;
      const Params: array of Variant; const RaiseExceptionIfNotFound: Boolean = True): T; overload;
    class function GetFirstByWhere<T: TMVCActiveRecordBase, constructor>(const SQLWhere: string;
      const Params: array of Variant; const ParamTypes: array of TFieldType;
      const RaiseExceptionIfNotFound: Boolean = True): T; overload;
    ...
    { Merge }
    class function Merge<T: TMVCActiveRecordBase>(CurrentList,
      NewList: TObjectList<T>; const MergeMode: TMergeMode = [mmInsert, mmUpdate, mmDelete]): IMVCMultiExecutor<T>;

    { Misc }
    class function All(const aClass: TMVCActiveRecordBaseClass): TObjectList<TMVCActiveRecordBase>;
      overload;
    class function All(const aQualifiedClassName: String): TObjectList<TMVCActiveRecordBase>;
      overload;
    class function DeleteAll(const aClass: TMVCActiveRecordBaseClass): Int64; overload;
    class function DeleteRQL(const aClass: TMVCActiveRecordBaseClass; const RQL: string): Int64; overload;
    function Count(const RQL: string = ''): Int64; overload;
    class function Count(const aClass: TMVCActiveRecordBaseClass; const RQL: string = '')
      : int64; overload;
    ...
    { NamedQuery}
    class function SelectByNamedQuery<T: TMVCActiveRecordBase, constructor>(
    ...
    class function SelectRQLByNamedQuery<T: constructor, TMVCActiveRecordBase>(
      const QueryName: String;
    ...
    class function DeleteRQLByNamedQuery<T: TMVCActiveRecordBase, constructor>(
      const QueryName: String;
      const Params: array of const): Int64;
    class function CountRQLByNamedQuery<T: TMVCActiveRecordBase, constructor>(
      const QueryName: string;
      const Params: array of const): Int64;
    class function TryGetSQLQuery<T: TMVCActiveRecordBase, constructor>(
      const QueryName: String;
      out   NamedSQLQuery: TSQLQueryWithName): Boolean; overload;
    class function TryGetRQLQuery<T: TMVCActiveRecordBase, constructor>(
      const QueryName: String; out NamedRQLQuery: TRQLQueryWithName): Boolean;
    { RTTI }
    class function CreateMVCActiveRecord<T: TMVCActiveRecordBase>(AQualifiedClassName: string; const AParams: TArray<TValue> = nil): T;
  end;
  ...
  IMVCActiveRecordTableMap = interface
    ...
    procedure AddTableMap(const AR: TMVCActiveRecordBase; const TableName: String; var TableMap: TMVCTableMap);
    function TryGetValue(const AR: TMVCActiveRecordBase; const TableName: String; out TableMap: TMVCTableMap): Boolean;
...
{$ENDIF}
  ...
  private
    ...
    function GetCacheKey(const AR: TMVCActiveRecordBase; const TableName: String): String; inline;
  protected
    procedure AddTableMap(const AR: TMVCActiveRecordBase; const TableName: String; var TableMap: TMVCTableMap);
    function TryGetValue(const AR: TMVCActiveRecordBase; const TableName: String; out TableMap: TMVCTableMap): Boolean;
    procedure ExecWithExclusiveLock(Proc: TProc<IMVCActiveRecordTableMap>);
  ...
  public
    ...
    function CreateInsertSQL(const TableMap: TMVCTableMap; const ARInstance: TMVCActiveRecordBase): string; virtual; abstract;

    // virtual methods with default implementation
    function CreateSelectByPKSQL(const TableName: string; const Map: TFieldsMap; const PKFieldName: string;
      const PKOptions: TMVCActiveRecordFieldOptions): string; virtual;
    function CreateDeleteSQL(const TableMap: TMVCTableMap; const ARInstance: TMVCActiveRecordBase): string; virtual;
    ...
    function CreateUpdateSQL(const TableMap: TMVCTableMap; const ARInstance: TMVCActiveRecordBase): string; virtual;
  ...
  TMVCUnitOfWork<T: TMVCActiveRecordBase> = class(TInterfacedObject, IMVCUnitOfWork<T>, IMVCMultiExecutor<T>)
  private
  ...
  protected
    ...
    // events
    procedure DoItemApplyAction(const Obj: TMVCActiveRecordBase; const EntityAction: TMVCEntityAction;
...
{$IFDEF USE_FIREDAC}
  ...
  public
    ...
    class function SelectDataSet(const SQL: string; const Params: array of Variant;
      const ParamTypes: array of TFieldType;
      const Unidirectional: Boolean = False;
      const DirectExecute: Boolean = False): TDataSet; override;
  end;
...
function EntityActionToString(A: TMVCEntityAction): string;
begin
  case A of
    eaCreate: Result := 'Create';
    eaRetrieve: Result := 'Retrieve';
    eaUpdate: Result := 'Update';
    eaDelete: Result := 'Delete';
  else
    Result := 'Unknown';
  end;
end;
...
class function TMVCActiveRecordFireDAC.SelectDataSet(const SQL: string;
  const Params: array of Variant; const ParamTypes: array of TFieldType;
  const Unidirectional, DirectExecute: Boolean): TDataSet;
begin
  Result := ExecQuery(SQL, Params, ParamTypes, Unidirectional, DirectExecute);
...
destructor TMVCActiveRecordBase.Destroy;
begin
  fChildren.Free;
  fSQLGenerator.Free;
  fRQL2SQL.Free;
...
procedure TMVCActiveRecordBase.EnsureConnection;
begin
  //GetConnection;
end;

function TMVCActiveRecordBase.ExecNonQuery(const SQL: string; RefreshAutoGenerated: Boolean = false): int64;
begin
  raise EAbstractError.Create('ExecNonQuery not implemented');
end;

procedure TMVCActiveRecordBase.FillPrimaryKey(const SequenceName: string);
begin
  raise EAbstractError.Create('FillPrimaryKey not implemented');
end;

function TMVCActiveRecordBase.FindRQLQueryByName(const QueryName: String;
...
function TMVCActiveRecordBase.FindSQLQueryByName(const QueryName: String;
...
procedure TMVCActiveRecordBase.InitTableInfo(const aTableName: String);
var
...
procedure TMVCActiveRecordBase.Insert;
var
  SQL: string;
begin
...
function TMVCActiveRecordBase.InternalCount(const RQL: string): int64;
var
  lSQL: string;
begin
...
function TMVCActiveRecordBase.InternalSelectRQL(const RQL: string;
...
begin
  ...
  Result := Select(TMVCActiveRecordBaseClass(Self.ClassType), lSQL, [], [], [], OutList);
end;

function TMVCActiveRecordBase.InternalSelectRQL(const RQL: string; const MaxRecordCount: Integer): TMVCActiveRecordList;
var
  lSQL: string;
begin
  lSQL := SQLGenerator.CreateSQLWhereByRQL(RQL, GetMapping, True, false, MaxRecordCount);
  LogD(Format('RQL [%s] => SQL [%s]', [RQL, lSQL]));
  Result := Where(TMVCActiveRecordBaseClass(Self.ClassType), lSQL, []);
end;

constructor TMVCActiveRecordBase.Create(aLazyLoadConnection: Boolean);
begin
  inherited Create;
...
function TMVCActiveRecordBase.GenerateSelectSQL: string;
begin
  Result := SQLGenerator.CreateSelectSQL(TableName, fTableMap.fMap,
    fTableMap.fPrimaryKeyFieldName, fTableMap.fPrimaryKeyOptions);
end;

function TMVCActiveRecordBase.GetAttributes(const AttrName: string): TValue;
var
...
function TMVCActiveRecordBase.GetBackEnd: string;
begin
  raise EAbstractError.Create('GetBackEnd not implemented');
end;

class function TMVCActiveRecordBase.GetByPK(aActiveRecord: TMVCActiveRecordBase; const aValue: string;
  const aFieldType: TFieldType; const RaiseExceptionIfNotFound: Boolean): TMVCActiveRecordBase;
var
  lFound: Boolean;
begin
...
class function TMVCActiveRecordHelper.GetByPK(const aClass: TMVCActiveRecordBaseClass; const aValue: string;
  const RaiseExceptionIfNotFound: Boolean): TMVCActiveRecordBase;
begin
  Result := GetByPK(aClass.Create, aValue, ftString, RaiseExceptionIfNotFound);
end;

class function TMVCActiveRecordHelper.GetByPK(const aClass: TMVCActiveRecordBaseClass; const aValue: int64;
  const RaiseExceptionIfNotFound: Boolean): TMVCActiveRecordBase;
begin
  Result := GetByPK(aClass.Create, aValue.ToString, ftInteger, RaiseExceptionIfNotFound);
end;

class function TMVCActiveRecordHelper.GetByPK(const aClass: TMVCActiveRecordBaseClass; const aValue: TGuid;
  const RaiseExceptionIfNotFound: Boolean): TMVCActiveRecordBase;
begin
...
function TMVCActiveRecordBase.GetMapping: TMVCFieldsMapping;
var
...
class function TMVCActiveRecordHelper.SelectRQLByNamedQuery(
  const MVCActiveRecordClass: TMVCActiveRecordBaseClass; const QueryName: String;
  const Params: array of const;
  const MaxRecordCount: Integer): TMVCActiveRecordList;
var
  lT: TMVCActiveRecordBase;
...
function TMVCActiveRecordBase.GetPartitionInfo: TPartitionInfo;
var
...
function TMVCActiveRecordBase.GetPK: TValue;
var
...
function TMVCActiveRecordBase.PKIsNull: Boolean;
var
  lValue: TValue;
  lIsNullableType: Boolean;
begin
...
function TMVCActiveRecordBase.PKIsNullable(out PKValue: TValue): Boolean;
var
  lValue: TValue;
begin
...
function TMVCActiveRecordBase.GetPrimaryKeyFieldType: TFieldType;
begin
  Result := fTableMap.fPrimaryKeyFieldType;
end;

function TMVCActiveRecordBase.GetPrimaryKeyIsAutogenerated: Boolean;
begin
  Result := foAutoGenerated in fTableMap.fPrimaryKeyOptions;
end;

class function TMVCActiveRecordBase.GetScalar(const SQL: string; const Params: array of Variant): Variant;
begin
  raise EAbstractError.Create('GetScalar not implemented');
end;

function TMVCActiveRecordBase.GetTableName: string;
begin
...
function TMVCActiveRecordBase.CheckAction(const aEntityAction: TMVCEntityAction; const aRaiseException: Boolean): Boolean;
begin
  ...
  if (not Result) and aRaiseException then
    raise EMVCActiveRecord.CreateFmt
      ...
      [EntityActionToString(aEntityAction), ClassName]) at ReturnAddress;
end;

class function TMVCActiveRecordHelper.Count(const aClass: TMVCActiveRecordBaseClass; const RQL: string): int64;
var
  lAR: TMVCActiveRecordBase;
begin
  lAR := aClass.Create;
  try
    ...
    // Instead of the Count() which exists in "TMVCActiveRecordBase"
...
begin
  Result := Count(TMVCActiveRecordBaseClass(T), RQL);
end;
...
begin
  ...
  try
    ...
    begin
      lTmp.Free;
      raise EMVCActiveRecord.Create(AQualifiedClassName + ' is not a TMVCActiveRecordBase descendant');
    end;
  end;
end;
...
begin
  Result := DeleteRQL(TMVCActiveRecordBaseClass(T), RQL);
end;
...
procedure TMVCActiveRecordBase.LoadByDataset(const aDataSet: TDataSet; const aOptions: TMVCActiveRecordLoadOptions);
var
...
function TMVCActiveRecordBase.LoadByPK(const id: string; const aFieldType: TFieldType): Boolean;
begin
  raise EAbstractError.Create('LoadByPK not implemented');
end;

function TMVCActiveRecordBase.LoadByPK(const id: string): Boolean;
begin
  Result := LoadByPK(id, ftString);
end;

function TMVCActiveRecordBase.LoadByPK(const id: int64): Boolean;
begin
  Result := LoadByPK(id.ToString, ftInteger);
end;

function TMVCActiveRecordBase.LoadByPK(const id: TGuid): Boolean;
begin
  Result := LoadByPK(id.ToString, ftGuid);
end;

procedure TMVCActiveRecordBase.OnAfterDelete;
begin
  // do nothing
end;

procedure TMVCActiveRecordBase.OnAfterInsert;
begin
  // do nothing
end;

procedure TMVCActiveRecordBase.OnAfterInsertOrUpdate;
begin
  // do nothing
end;

procedure TMVCActiveRecordBase.OnAfterLoad;
begin
  // do nothing
end;

procedure TMVCActiveRecordBase.OnAfterUpdate;
begin
  // do nothing
end;

procedure TMVCActiveRecordBase.OnBeforeDelete;
begin
  // do nothing
end;

procedure TMVCActiveRecordBase.OnBeforeExecuteSQL(var SQL: string);
begin
  // do nothing
end;

class procedure TMVCActiveRecordBase.OnBeforeExecuteQuerySQL(var SQL: string);
begin
  // do nothing
end;

procedure TMVCActiveRecordBase.OnBeforeInsert;
begin
  // do nothing
end;

procedure TMVCActiveRecordBase.OnBeforeInsertOrUpdate;
begin
  // do nothing
end;

procedure TMVCActiveRecordBase.OnBeforeLoad;
begin
  // do nothing
end;

procedure TMVCActiveRecordBase.OnBeforeUpdate;
begin
  // do nothing
end;

procedure TMVCActiveRecordBase.OnValidation(const EntityAction: TMVCEntityAction);
begin
  // do nothing
end;

procedure TMVCActiveRecordBase.Refresh;
begin
...
procedure TMVCActiveRecordBase.RemoveChildren(const ChildObject: TObject);
begin
...
procedure TMVCActiveRecordBase.InvalidateConnection(const ReacquireAfterInvalidate: Boolean = false);
begin
  //
end;

class function TMVCActiveRecordHelper.Select(const aClass: TMVCActiveRecordBaseClass; const SQL: string;
  const Params: array of Variant): TMVCActiveRecordList;
begin
  Result := Where(aClass, ' ' + SQL, Params);
end;
...
begin
  Result := TMVCActiveRecord.SelectDataSet(SQL, Params, ParamTypes, Unidirectional, DirectExecute);
end;
...
begin
  Result := SelectDataSet(SQL, Params, [], Unidirectional, DirectExecute);
end;
...
class function TMVCActiveRecordHelper.SelectRQL(const aClass: TMVCActiveRecordBaseClass;
...
class function TMVCActiveRecordHelper.Select(
  const MVCActiveRecordClass: TMVCActiveRecordBaseClass; const SQL: string;
  const Params: array of Variant; const ParamTypes: array of TFieldType;
  const Options: TMVCActiveRecordLoadOptions;
  const OutList: TMVCActiveRecordList): UInt32;
begin
  raise EAbstractError.Create('Select not implemented');
end;
...
class function TMVCActiveRecordHelper.SelectRQL(const aClass: TMVCActiveRecordBaseClass; const RQL: string;
  const MaxRecordCount: Integer): TMVCActiveRecordList;
var
  lAR: TMVCActiveRecordBase;
begin
...
procedure TMVCActiveRecordBase.SetAttributes(const AttrName: string; const Value: TValue);
var
  lProperty: TRttiProperty;
begin
  if not TRttiUtils.ExistsProperty(Self, AttrName, lProperty) then
...
procedure TMVCActiveRecordBase.SetPropertyValue(const aProp: TRttiProperty; const aValue: TValue);
var
  lCurrValue: TValue;
...
procedure TMVCActiveRecordBase.SetPK(const aValue: TValue);
var
  lPKValue: TValue;
begin
...
procedure TMVCActiveRecordBase.SetPrimaryKeyIsAutogenerated(const Value: Boolean);
begin
  if Value then
  begin
...
procedure TMVCActiveRecordBase.SetInitialObjVersion(const TableMap: TMVCTableMap;
  const ARInstance: TMVCActiveRecordBase);
begin
  TableMap.fVersionRTTIField.SetValue(ARInstance, OBJECT_VERSION_STARTING_VALUE_AS_INT);
end;

function TMVCActiveRecordBase.SQLGenerator: TMVCSQLGenerator;
var
...
procedure TMVCActiveRecordBase.Store;
var
  lValue: TValue;
  lRes: Boolean;
  lIsNullableType: Boolean;
...
function TMVCActiveRecordBase.TableInfo: string;
var
...
function TMVCActiveRecordBase.TryGetPKValue(var Value: TValue; out IsNullableType: Boolean): Boolean;
begin
...
procedure TMVCActiveRecordBase.Update(const RaiseExceptionIfNotFound: Boolean = True);
var
  SQL: string;
  lAffectedRows: int64;
begin
...
begin
  raise EAbstractError.Create('Where not implemented');
end;

procedure TMVCActiveRecordBase.AddChildren(const ChildObject: TObject);
begin
  if fChildren = nil then
  begin
...
class function TMVCActiveRecordHelper.All(const aClass: TMVCActiveRecordBaseClass): TObjectList<TMVCActiveRecordBase>;
var
  lAR: TMVCActiveRecordBase;
begin
  lAR := aClass.Create;
...
procedure TMVCActiveRecordBase.AdvanceVersioning(const TableMap: TMVCTableMap; const ARInstance: TMVCActiveRecordBase);
var
  lCurrVersion: Int64;
begin
...
procedure TMVCActiveRecordBase.Assign(ActiveRecord: TMVCActiveRecordBase);
begin
  //do nothing
end;

class function TMVCActiveRecordHelper.All(const aQualifiedClassName: String): TObjectList<TMVCActiveRecordBase>;
var
  lAR: TMVCActiveRecordBase;
begin
  lAR := CreateMVCActiveRecord<TMVCActiveRecordBase>(aQualifiedClassName, []);
  try
    Result := Select(TMVCActiveRecordBaseClass(lAR.ClassType),
      lAR.GenerateSelectSQL + lAR.SQLGenerator.GetDefaultSQLFilter(True), []);
  finally
    lAr.Free;
  end;
...
function TMVCSQLGenerator.CreateDeleteSQL(const TableMap: TMVCTableMap; const ARInstance: TMVCActiveRecordBase): string;
begin
...
function TMVCSQLGenerator.CreateUpdateSQL(const TableMap: TMVCTableMap; const ARInstance: TMVCActiveRecordBase): string;
var
  lPair: TPair<TRTTIField, TFieldInfo>;
//  I: Integer;
begin
...
{$IFDEF USE_FIREDAC}
class function TMVCActiveRecordFireDAC.ExecQuery(
  const SQL: string;
  const Values: array of Variant;
  const ValueTypes: array of TFieldType;
  const Connection: TFDConnection;
...
class function TMVCActiveRecordFireDAC.ExecQuery(const SQL: string; const Values: array of Variant;
...
procedure TMVCUnitOfWork<T>.DoItemApplyAction(const Obj: TMVCActiveRecordBase; const EntityAction: TMVCEntityAction;
  const ItemApplyAction: TMVCItemApplyAction<T>; var Handled: Boolean);
begin
  if Assigned(ItemApplyAction) then
  begin
    ItemApplyAction(T(Obj), EntityAction, Handled);
  end;
end;
...
procedure TMVCTableMapRepository.AddTableMap(const AR: TMVCActiveRecordBase; const TableName: String; var TableMap: TMVCTableMap);
var
  lKey: string;
...
function TMVCTableMapRepository.GetCacheKey(const AR: TMVCActiveRecordBase; const TableName: String): String;
begin
  Result := AR.QualifiedClassName + ':' + TableName;
end;

function TMVCTableMapRepository.TryGetValue(
  const AR: TMVCActiveRecordBase;
...
function TMVCTableMap.VersionValueAsInt64For(AR: TMVCActiveRecordBase): Int64;
begin
...
constructor TMVCActiveRecordBase.Create;
begin
  Create(True);
end;
