...
type
  ...
  public
    ...
    function CreateSQLWhereByRQL(const RQL: string;
      const Mapping: TMVCFieldsMapping; const UseArtificialLimit: Boolean = True): string; virtual; abstract;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if not(foNoUpdate in MVCTableFieldAttribute(lAttribute).FieldOptions)
        then
          fMapUpdate.Add(lRTTIField, MVCTableFieldAttribute(lAttribute)
            .FieldName);
      end
...
begin
  ...
  SQL := SQLGenerator.CreateInsertSQL(fTableName, fMapUpdate,
...
begin
  ...
  SQL := SQLGenerator.CreateUpdateSQL(fTableName, fMapUpdate,
    fPrimaryKeyFieldName, fPrimaryKeyOptions);
  ExecNonQuery(SQL, false);
  OnAfterUpdate;
  OnAfterInsertOrUpdate;
