...
unit MVCFramework.Filters.CORS;
...
constructor TMVCCORSProtocolFilter.Create(
...
procedure TMVCCORSProtocolFilter.DoFilter(Context: TWebContext);
var
  lHeaders: TStrings;
begin
  lHeaders := Context.Response.RawWebResponse.CustomHeaders;
  lHeaders.Values['Access-Control-Allow-Origin'] := FAllowedOriginURL;
  lHeaders.Values['Access-Control-Allow-Methods'] := FAllowsMethods;
  lHeaders.Values['Access-Control-Allow-Headers'] := FAllowsHeaders;
  lHeaders.Values['Access-Control-Allow-Credentials'] := FAllowsCredentials;
  lHeaders.Values['Access-Control-Expose-Headers'] := FExposeHeaders;
