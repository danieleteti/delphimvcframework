...
begin
  ...
  try
    ...
    // Every PK column that participates in the INSERT (natural columns). Empty
    // for a single auto-generated PK. Single-PK: identical to the old emission.
    ...
    else if TableMap.fAutoGenPKIndex >= 0 then
    begin
      lSB.Append(' ; SELECT last_insert_rowid() as ' +
        AutoGenPKFieldName(TableMap) + ';');
    end;
    Result := lSB.ToString;
  finally
    lSB.Free;
