...
begin
  ...
  try
    ...
    // PrimaryKeyIsAutogenerated describes ONE column: answering from column [0]
    // would report False for a key whose generated column sits elsewhere.
    Assert.WillRaise(procedure begin lE.PrimaryKeyIsAutogenerated end, EMVCActiveRecord,
      'reading PrimaryKeyIsAutogenerated must raise on a composite key');
