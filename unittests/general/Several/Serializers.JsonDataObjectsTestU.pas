...
const
  JSON = '{' + '"Id":1,' + '"Code":2,' + '"Name":"Ezequiel Juliano M�ller",' + '"Salary":100,' +
...
const
  JSON_PROPERTIES = '{' + '"Id":1,' + '"Code":2,' + '"Name":"Ezequiel Juliano M�ller",' + '"Salary":100,' +
  ...
  JSON_FIELDS = '{' + '"FId":1,' + '"FCode":2,' + '"FName":"Ezequiel Juliano M�ller",' + '"FSalary":100,' +
...
const
  ...
  JSON_NULLS = '{' + '"Id":1,' + '"Code":2,' + '"Name":"Ezequiel Juliano M�ller",' + '"Salary":100,' +
