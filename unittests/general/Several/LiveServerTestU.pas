...
begin
  res := RESTClient
    ...
    .Post('/testconsumes/textiso8859_1', 'אטילעש', BuildContentType(TMVCMediaType.TEXT_PLAIN, TMVCCharSet.ISO88591));
  Assert.areEqual<Integer>(HTTP_STATUS.OK, res.StatusCode);
...
begin
  ...
  lRes := RESTClient.Accept(TMVCMediaType.TEXT_HTML).Get('/..\donotdeleteme.txt');
...
begin
  ...
  begin
    res := RESTClient
      .AddPathParam('value', S)
      .Get('/typed/string1/{value}');
