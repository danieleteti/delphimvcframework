...
begin
  ...
  // Test 59: controller project, option ON. Swagger middleware with OpenAPI 3,
  ...
  // Test 60: same controller project, option OFF: nothing of the above.
  ...
  // Test 61: WebModule flavor (ISAPI), option ON: the same wiring in WebModuleU.
  ...
  // Test 62: Minimal API, option ON: native OpenAPI() filter, route metadata,
  ...
  // Test 63: controller project with Sqids and the option ON: the ($ID:sqids)
  ...
  // Test 64: Minimal API, option OFF.
