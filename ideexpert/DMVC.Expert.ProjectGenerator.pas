...
begin
  ...
  // Always create .env file in bin/ with project defaults
  LEnvContent := '# Environment configuration' + sLineBreak +
    '# Generated by DMVCFramework Project Wizard' + sLineBreak +
    sLineBreak +
  ...
  if AConfig.B[TConfigKey.webmodule_middleware_activerecord] then
    LEnvContent := LEnvContent +
      sLineBreak +
      '# Database configuration (ActiveRecord)' + sLineBreak +
      'DB_CONNECTION_DEF_NAME=' + AConfig.S[TConfigKey.webmodule_middleware_activerecord_con_def_name] + sLineBreak +
